    ...
    <Container size="sm" py={100}>
      <Card shadow="lg" p="xl" radius="md" withBorder>
        <Stack align="center" gap="xl">
          <ThemeIcon color="orange" size={80} radius={40} variant="light">
            <IconX size={50} />
          </ThemeIcon>

          <Stack align="center" gap="xs">
            <Title order={2} ta="center" c="orange">Payment Cancelled</Title>
            <Text c="dimmed" size="sm" ta="center">
              The transaction was cancelled and no funds were debited.
            </Text>
          </Stack>
          ...
          <Card withBorder p="md" radius="sm" style={{ width: '100%' }} bg="var(--mantine-color-gray-0)">
            ...
            <Group justify="space-between" mt="xs">
              ...
              <Text size="xs" fw={700} c="orange">CANCELLED</Text>
            </Group>
          </Card>
