    ...
    return (
      ...
      >
        <Group gap={6} align="center" wrap="nowrap">
          <link.icon size={15} className="nav-icon" />
    ...
    return (
      ...
      >
        <Group gap="sm" align="center">
          <link.icon size={18} style={{ color: isActive ? '#60a5fa' : 'rgba(255, 255, 255, 0.6)' }} />
          <Text size="sm" fw={isActive ? 700 : 500} c={isActive ? 'white' : 'gray.3'}>
            {link.label}
          </Text>
        </Group>
      </Link>
            ...
            <Container size="xl">
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '40px', marginBottom: '40px' }}>
                ...
                <div>
                  ...
                  <Stack gap="sm">
                    <Text size="sm" component={Link} href="/" style={{ color: '#cbd5e1', textDecoration: 'none' }}>
                      হোম
                    </Text>
                    <Text size="sm" component={Link} href="/courses" style={{ color: '#cbd5e1', textDecoration: 'none' }}>
                      কোর্সসমূহ
                    </Text>
                    <Text size="sm" component={Link} href="/dashboard" style={{ color: '#cbd5e1', textDecoration: 'none' }}>
                      ড্যাশবোর্ড
                    </Text>
                    <Text size="sm" component={Link} href="/profile" style={{ color: '#cbd5e1', textDecoration: 'none' }}>
                      প্রোফাইল
                    </Text>
                  </Stack>
                </div>
